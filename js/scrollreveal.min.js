...
sr.reveal(`.card-two, .container-fluid`)
// sr.reveal(`.card-img`,{origin : 'top'})
// sr.reveal(`.main-class, .container-fluid`,{interval : 100})
// sr.reval (`.about-image`,{origin : 'left'})

ScrollReveal().reveal('.about-module', {
	duration: 1500,
	origin: 'left',
	distance: '50px',
	easing: 'ease-in-out',
...
ScrollReveal().reveal('.about-us-img img', {
	duration: 1500,
	origin: 'right',
	distance: '100px',
	easing: 'ease-in-out',
...
ScrollReveal().reveal('.product-card', {
	...
	distance: '50px',
	easing: 'ease-in-out',
	interval: 200  // Staggered reveal for each product
});
...
ScrollReveal().reveal('.blog-post', {
	...
	distance: '50px',
	easing: 'ease-in-out',
	interval: 200  // Staggered reveal for each blog post
});

ScrollReveal().reveal('.blog-post-title', {
	duration: 800,
	origin: 'left',
	distance: '30px',
	easing: 'ease-in-out'
...
ScrollReveal().reveal('.blog-post-excerpt', {
	duration: 800,
	origin: 'right',
	distance: '30px',
	easing: 'ease-in-out',
...
// Optional: Add form submission script
document.getElementById('contactForm').addEventListener('submit', function(event) {
	event.preventDefault();
	alert('Thank you for your message! We will get back to you soon.');
	// Implement form submission logic here (e.g., send an email or POST to a server)
});
